...
class LibgenUploadHandler:
    ...
    def _get_metadata_elements(self):
        ...
        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(form_element_locator))
    ...
    def _provide_metadata(self):
        ...
        try:
            ...
            logging.error(f"Trying to upload file with invalid language value. {self.current_metadata.language}")
            raise UploaderError(f"Trying to upload file with invalid language value. {self.current_metadata.language}")
        ...
        for entry in uploadable_history:
            ...
            with yaspin(text="Uploading file", color="yellow") as spinner:
                ...
                try:
                    ...
                    spinner.message("Error while sending file. Check logs.")
                    spinner.fail("✘")
                    continue
